...
export const bgTeamsLive = require("@/../assets/generated/bg-teams-live-dark.webp");
export const bgTeamsLiveLight = require("@/../assets/generated/bg-teams-live-light.webp");
export const bgLeaguesLive = require("@/../assets/generated/bg-leagues-live-dark.webp");
export const bgLeaguesLiveLight = require("@/../assets/generated/bg-leagues-live-light.webp");
export const bgTournamentsLive = require("@/../assets/generated/bg-tournaments-live-dark.webp");
export const bgTournamentsLiveLight = require("@/../assets/generated/bg-tournaments-live-light.webp");

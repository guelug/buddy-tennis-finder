...
const I18N = {
  es: {
    "meta.title": "MP Tennis League App — Encuentra tu próximo partido",
    "meta.description": "Encuentra tenistas de tu nivel, organiza partidos y sube en un ranking validado con MP Tennis League App.",
    "a11y.ios": "Descargar MP Tennis League App para iPhone",
    "a11y.android": "Descargar MP Tennis League App para Android",
    "a11y.benefits": "Ventajas de MP Tennis League App",
    "a11y.preview": "Vista previa de MP Tennis League App",
    "a11y.community": "Comunidad de MP Tennis League App",
    "a11y.prev": "Anterior",
    "a11y.next": "Siguiente",
    "a11y.founders": "Fundadores de MP Tennis League App",
    "a11y.free": "Descargar MP Tennis League App gratis",
    "a11y.step": "Paso {n}",
    ...
    "hero.availability": "Gratis · iPhone y Android · Disponible en Ciudad de Guatemala, Barcelona y San Salvador · Más ciudades muy pronto",
    "cities.eyebrow": "Ciudades",
    "cities.title": "Dónde se está moviendo MatchPoint.",
    "cities.now": "Activas ahora",
    "cities.soon": "Próximamente",
    "cities.c1": "Ciudad de Guatemala",
    "cities.c2": "Barcelona",
    "cities.c3": "San Salvador",
    "cities.c4": "Madrid",
    "cities.c5": "Valencia",
    "cities.c6": "Sevilla",
    "cities.c7": "Girona",
    ...
    "priv.sub": "Solo te pedimos lo necesario para jugar. Tratamos datos técnicos de forma limitada y transparente para proteger, medir y mejorar la app.",
    "priv.k1": "MÍNIMO",
    ...
    "priv.k2": "MEJORA",
    "priv.c2t": "Diagnóstico responsable",
    "priv.c2p": "Los datos técnicos y de uso nos ayudan a prevenir fraude y detectar fallos. Explicamos proveedores, finalidades y controles en la política de privacidad.",
    "priv.k3": "CONTROL",
    "priv.c3t": "Tú tienes el control",
    "priv.c3p": "Solicita la eliminación desde la app y consulta en la política qué datos se borran, desvinculan o conservan por seguridad y obligaciones legales.",

    "price.eyebrow": "Sin letra pequeña",
    "price.title": "Gratis para jugar.<br><span class=\"accent\">Sin suscripción.</span>",
    "price.sub": "Las funciones esenciales son gratuitas. La app contiene publicidad y puede ofrecer compras puntuales opcionales.",
    "price.plan": "Jugador",
    "price.forever": "/ funciones esenciales",
    ...
    "faq.a2": "Encontrar rivales, organizar partidos y competir es gratuito. La app contiene publicidad y puede ofrecer compras puntuales opcionales.",
    ...
    "cta.ios": " iPhone",
    "cta.android": "▶ Android",
    "cta.note": "Descarga gratuita · Contiene anuncios y compras opcionales",

    "footer.copy": "© 2026 MP Tennis League App · Hecha por tenistas, para tenistas",
  ...
  en: {
    "meta.title": "MP Tennis League App — Find your next match",
    "meta.description": "Find tennis players at your level, organize matches and climb a verified ranking with MP Tennis League App.",
    "a11y.ios": "Download MP Tennis League App for iPhone",
    "a11y.android": "Download MP Tennis League App for Android",
    "a11y.benefits": "Benefits of MP Tennis League App",
    "a11y.preview": "MP Tennis League App preview",
    "a11y.community": "MP Tennis League App community",
    "a11y.prev": "Previous",
    "a11y.next": "Next",
    "a11y.founders": "Founders of MP Tennis League App",
    "a11y.free": "Download MP Tennis League App for free",
    "a11y.step": "Step {n}",
      ...
      "hero.availability": "Free · iPhone and Android · Available in Guatemala City, Barcelona and San Salvador · More cities coming soon",
      "cities.eyebrow": "Cities",
      "cities.title": "Where MatchPoint is moving.",
      "cities.now": "Live now",
      "cities.soon": "Coming soon",
      "cities.c1": "Guatemala City",
      "cities.c2": "Barcelona",
    "cities.c3": "San Salvador",
    "cities.c4": "Madrid",
    "cities.c5": "Valencia",
    ...
    "cities.c8": "Tarragona",
      ...
      "priv.sub": "We only ask for what you need to play. Technical data is handled in a limited and transparent way to protect, measure and improve the app.",
      "priv.k1": "MINIMUM",
      ...
      "priv.k2": "IMPROVEMENT",
      "priv.c2t": "Responsible diagnostics",
      "priv.c2p": "Technical and usage data helps us prevent fraud and find issues. Providers, purposes and controls are explained in our privacy policy.",
      "priv.k3": "CONTROL",
      "priv.c3t": "You’re in control",
      "priv.c3p": "Request deletion in the app and read the policy to see what is deleted, unlinked or retained for security and legal obligations.",
      "price.eyebrow": "No fine print",
      "price.title": "Free to play.<br><span class=\"accent\">No subscription.</span>",
      "price.sub": "Essential features are free. The app contains advertising and may offer optional one-time purchases.",
      "price.plan": "Player",
      "price.forever": "/ essential features",
      ...
      "faq.a2": "Finding opponents, organizing matches and competing is free. The app contains advertising and may offer optional one-time purchases.",
      ...
      "cta.ios": "  iPhone",
      "cta.android": "▶ Android",
      "cta.note": "Free download · Contains ads and optional purchases",
      "footer.copy": "© 2026 MP Tennis League App · Made by tennis players, for tennis players",
  ...
  ca: {
      "meta.title": "MP Tennis League App — Troba el teu pròxim partit",
      "meta.description": "Troba tennistes del teu nivell, organitza partits i puja en un rànquing validat amb MP Tennis League App.",
      "a11y.ios": "Baixa MP Tennis League App per a iPhone",
      "a11y.android": "Baixa MP Tennis League App per a Android",
      "a11y.benefits": "Avantatges de MP Tennis League App",
      "a11y.preview": "Vista prèvia de MP Tennis League App",
      "a11y.community": "Comunitat de MP Tennis League App",
      "a11y.prev": "Anterior",
      "a11y.next": "Següent",
      "a11y.founders": "Fundadors de MP Tennis League App",
      "a11y.free": "Baixa MP Tennis League App gratis",
      "a11y.step": "Pas {n}",
      ...
      "hero.availability": "Gratis · iPhone i Android · Disponible a Ciutat de Guatemala, Barcelona i San Salvador · Més ciutats molt aviat",
      "cities.eyebrow": "Ciutats",
      "cities.title": "On s'està movent MatchPoint.",
      "cities.now": "Actives ara",
      "cities.soon": "Pròximament",
      "cities.c1": "Ciutat de Guatemala",
      "cities.c2": "Barcelona",
      "cities.c3": "San Salvador",
      "cities.c4": "Madrid",
      "cities.c5": "València",
      ...
      "priv.sub": "Només et demanem el necessari per jugar. Tractem les dades tècniques de manera limitada i transparent per protegir, mesurar i millorar l’app.",
      "priv.k1": "MÍNIM",
      ...
      "priv.k2": "MILLORA",
      "priv.c2t": "Diagnòstic responsable",
      "priv.c2p": "Les dades tècniques i d’ús ens ajuden a prevenir frau i detectar errors. Expliquem proveïdors, finalitats i controls a la política de privadesa.",
      "priv.k3": "CONTROL",
      "priv.c3t": "Tu tens el control",
      "priv.c3p": "Sol·licita l’eliminació des de l’app i consulta a la política què s’elimina, es desvincula o es conserva per seguretat i obligacions legals.",
      "price.eyebrow": "Sense lletra petita",
      "price.title": "Gratis per jugar.<br><span class=\"accent\">Sense subscripció.</span>",
      "price.sub": "Les funcions essencials són gratuïtes. L’app conté publicitat i pot oferir compres puntuals opcionals.",
      "price.plan": "Jugador",
      "price.forever": "/ funcions essencials",
      ...
      "faq.q2": "Quant costa?",
      "faq.a2": "Trobar rivals, organitzar partits i competir és gratuït. L’app conté publicitat i pot oferir compres puntuals opcionals.",
      ...
      "cta.ios": "  iPhone",
      "cta.android": "▶ Android",
      "cta.note": "Descàrrega gratuïta · Conté anuncis i compres opcionals",
      "footer.copy": "© 2026 MP Tennis League App · Feta per tennistes, per a tennistes",
  ...
  ko: {
      "meta.title": "MP Tennis League App — 다음 테니스 경기를 찾아보세요",
      "meta.description": "내 실력에 맞는 테니스 선수를 찾고, 경기를 편하게 잡고, 두 선수가 확인한 랭킹에 도전하세요.",
      "a11y.ios": "iPhone용 MP Tennis League App 다운로드",
      "a11y.android": "Android용 MP Tennis League App 다운로드",
      "a11y.benefits": "MP Tennis League App 주요 기능",
      "a11y.preview": "MP Tennis League App 미리보기",
      "a11y.community": "MP Tennis League App 커뮤니티",
      "a11y.prev": "이전",
      "a11y.next": "다음",
      "a11y.founders": "MP Tennis League App 창업자",
      "a11y.free": "MP Tennis League App 무료 다운로드",
      "a11y.step": "{n}단계",
      "nav.how": "이용 방법",
      "nav.tour": "앱 둘러보기",
      "nav.leagues": "리그",
      ...
      "nav.faq": "자주 묻는 질문",
      "nav.cta": "공유",
      "share.text": "MatchPoint를 만나보세요. 비슷한 실력의 테니스 상대를 찾고, 경기를 즐기며 랭킹에 도전할 수 있어요 🎾",
      "share.toast": "링크가 복사되었습니다!",
      "hero.eyebrow": "내 도시 · 내 실력 · 다음 경기",
      "hero.title": "상대 찾기는 그만.<br><span class=\"accent\">바로 경기하세요.</span>",
      "hero.lead": "MatchPoint는 비슷한 실력의 테니스 선수를 연결하고, 코트가 예약된 경기를 간편하게 잡아 줍니다. 두 선수가 확인한 결과는 실제 경기력을 보여 주는 랭킹에 반영됩니다.",
      "hero.ios": "iPhone으로 다운로드",
      "hero.android": "Android로 다운로드",
      "hero.availability": "무료 · iPhone 및 Android · 과테말라 시티, 바르셀로나, 산살바도르에서 사용 가능 · 더 많은 도시 곧 오픈",
      "cities.eyebrow": "도시",
      "cities.title": "MatchPoint가 움직이는 도시.",
      "cities.now": "지금 이용 가능",
      "cities.soon": "곧 오픈",
      "cities.c1": "과테말라 시티",
      "cities.c2": "바르셀로나",
      ...
      "cities.c8": "타라고나",
      "hero.proof1": "✓ 잘 맞는 상대",
      "hero.proof2": "✓ 코트가 잡힌 경기",
      "hero.proof3": "✓ 검증된 랭킹",
      "hero.scroll": "스크롤",
      "float.cta": "무료 다운로드",
      "showcase.cap1": "앱을 열자마자 다음 경기 확인",
      "showcase.cap2": "내 실력에 맞는 상대만 정확하게",
      "showcase.cap3": "채팅 실랑이 없이 경기 확정",
      "showcase.cap4": "코트에서 쟁취하는 랭킹",
      "showcase.cap5": "내 플레이는 상대의 평가로 완성",
      "proof.city": "다음 주인공은 당신의 도시",
      "proof.stat1": "% 핵심 기능 무료",
      "proof.stat2": "명의 선수가 모든 결과를 확인",
      "proof.stat3": "개 기술 항목을 상대가 평가",
      "proof.stat4": "번의 터치로 상대 찾기",
      "feat.eyebrow": "내 손안의 테니스 클럽",
      ...
      "feat.c1t": "잘 맞는 상대",
      "feat.c1p": "도시, 실력, 가능 시간, 종목별로 가까운 테니스 선수를 만나보세요. 잡음은 줄이고, 경기의 질은 높이세요.",
      "feat.c2t": "공개 경기",
      "feat.c2p": "코트를 이미 예약하셨나요? 예약 정보를 올리고 단체 채팅방을 뒤지지 않고도 잘 맞는 상대를 찾아보세요.",
      "feat.c3t": "두 선수가 확인하는 결과",
      "feat.c3p": "한 선수가 결과를 입력하면 상대가 확인합니다. 랭킹은 실제 경기 결과로만 쌓입니다.",
      "feat.c4t": "클럽과 코치",
      "feat.c4p": "자주 가는 클럽을 저장하고, 새로운 코트를 발견하고, 가까이에서 훈련하는 코치를 찾아보세요.",
      "feat.c5t": "내 Match Buddy",
      "feat.c5p": "앱 안에서 궁금증을 해결하고, 경기를 준비하고, 다음 단계를 발견하세요.",
      "feat.c6t": "내 도시 우선",
      "feat.c6p": "내 동네에서 알찬 기회를 찾고, 개인정보는 내 손 안에 두세요.",
      "tour.eyebrow": "앱 둘러보기",
      "tour.title": "MatchPoint에서는 경기를<br><span class=\"accent\">이렇게 시작합니다.</span>",
      "tour.sub": "앱을 여는 순간부터 랭킹을 오르기까지, 다섯 단계면 됩니다. 단톡방도 없고, 점수 다툼도 없습니다.",
      "tour.s1t": "앱을 열자마자 다음 경기 확인",
      "tour.s1p": "앱을 열면 다음 일정의 클럽과 시간을 바로 확인할 수 있습니다. 한 번만 누르면 상대 찾기, 경기 등록, 내 순위 확인으로 이동합니다.",
      "tour.s2t": "아무나가 아닌, 내 실력의 상대",
      "tour.s2p": "도시, 실력, 나이, 가능 시간으로 필터링하세요. 모든 프로필에는 평가와 기술 메모가 함께 제공되니, 만나기 전에 어떤 경기를 하게 될지 알 수 있습니다.",
      "tour.s3t": "채팅 실랑이 없이 경기 확정",
      "tour.s3p": "내 예약을 올리거나 다른 사람의 경기에 참가를 요청하세요. 일정, 코트, 확인은 앱이 정리해 주므로 복잡한 대화가 필요 없습니다.",
      "tour.s4t": "두 선수가 함께 확인하는 결과",
      "tour.s4p": "한 명이 점수를 기록하고 상대가 확인합니다. 그래야만 순위에 반영되니, 랭킹은 실제 경기를 담습니다.",
      "tour.s5t": "내 플레이를 가장 잘 아는 상대의 평가",
      "tour.s5p": "경기가 끝나면 서로의 서브, 포핸드, 백핸드, 발리, 일관성을 평가합니다. 시간이 지나면 프로필은 내가 말하는 것이 아니라 내가 증명하는 것이 됩니다.",
      ...
      "league.lead": "초급부터 A 디비전까지. 내 실력에 맞는 디비전에 참가하고, 서로 가능한 시간에 경기하세요. 두 선수가 확인한 결과만 투명한 순위표에 반영됩니다.",
      "league.st1": "실력과 도시를 선택하세요.",
      "league.st2": "지역 리그에 참여하세요.",
      "league.st3": "경기를 하고 점수를 기록하세요.",
      ...
      "about.title": "테니스 선수가 만든,<br><span class=\"accent\">더 많이 치기 위한 앱.</span>",
      "about.lead": "MatchPoint는 회의실이 아니라 코트에서 시작됐습니다. 실력에 맞는 상대를 찾고 경기를 잡으며, 끝없는 단체 채팅 없이 경쟁하고 싶다는 현실적인 고민에서 출발했습니다.",
      ...
      "testers.title": "다양한 전문가가 직접 테스트했습니다.",
      "testers.sub": "MatchPoint는 여러 분야의 초기 알파 테스터가 직접 사용하고 전한 솔직한 의견을 바탕으로 성장해 왔습니다. 각자의 전문적인 관점이 제품을 더 단단하게 만들었습니다.",
      "t.david.role": "프로그래머",
      "t.david.note": "프로그래머: 기술적인 시선으로 테스트하며, 경기와 랭킹에서 어긋나는 부분을 잡아냅니다.",
      ...
      "t.elcin.note": "경제학자이자 프로젝트 매니저로서 체코에서 여러 팀을 이끈 경험을 바탕으로, 프로덕트 오너의 관점에서 테스트했습니다.",
      ...
      "priv.sub": "플레이에 필요한 정보만 요청합니다. 기술 데이터는 앱의 보호, 측정, 개선을 위해 제한적이고 투명하게 처리됩니다.",
      "priv.k1": "최소",
      "priv.c1t": "꼭 필요한 것만",
      "priv.c1p": "선수 프로필, 도시, 경기 기록. 그 이상 없습니다. 상대를 찾고 기록을 유지하는 데 필요한 만큼만요.",
      "priv.k2": "개선",
      "priv.c2t": "책임 있는 진단",
      "priv.c2p": "기술 및 사용 데이터는 사기를 방지하고 오류를 찾는 데 도움이 됩니다. 제공업체, 목적, 제어 방법은 개인정보 처리방침에 설명되어 있습니다.",
      "priv.k3": "통제권",
      "priv.c3t": "통제권은 당신에게",
      "priv.c3p": "앱에서 삭제를 요청하고 개인정보 처리방침에서 보안 및 법적 의무에 따라 삭제, 연결 해제 또는 보존되는 데이터를 확인하세요.",
      "price.eyebrow": "숨은 조건 없이",
      "price.title": "무료 플레이.<br><span class=\"accent\">구독 없음.</span>",
      "price.sub": "핵심 기능은 무료입니다. 앱에는 광고가 포함되며 선택적 일회성 구매가 제공될 수 있습니다.",
      "price.plan": "선수",
      "price.forever": "/ 핵심 기능",
      "price.f1": "실력과 도시별로 잘 맞는 상대",
      "price.f2": "열린 경기와 코트가 잡힌 예약",
      ...
      "faq.sub": "첫 경기부터 모든 것이 명확합니다.",
      "faq.q1": "MatchPoint는 누구를 위한 앱인가요?",
      "faq.a1": "더 자주 경기하고 일정을 편하게 관리하고 싶은 테니스 선수를 위한 앱입니다. 처음 라켓을 잡은 분부터 실력 향상을 위해 경쟁하는 분까지 누구나 이용할 수 있습니다.",
      "faq.q2": "이용 요금은 얼마인가요?",
      "faq.a2": "상대 찾기, 경기 주선, 랭킹 경쟁은 무료입니다. 앱에는 광고가 포함되며 선택적 일회성 구매가 제공될 수 있습니다.",
      "faq.q3": "어떻게 상대를 찾나요?",
      "faq.a3": "도시, 실력, 종목, 가능 시간을 입력하세요. MatchPoint가 잘 맞는 프로필과 경기를 보여주니, 누구와 칠지 고를 수 있습니다.",
      "faq.q4": "누가 결과를 검증하나요?",
      "faq.a4": "상대가 점수를 확인합니다. 그래서 랭킹은 실제 경기로 채워지고, 스스로 매긴 점수는 반영되지 않습니다.",
      "faq.q5": "클럽에 가입해야 하나요?",
      "faq.a5": "아닙니다. 내 동네의 선수들을 발견하고, 자주 가는 클럽을 저장하고, 가장 잘 맞는 경기를 직접 주선할 수 있습니다.",
      ...
      "cta.sub": "모든 경기가 기록이 됩니다. 더 다양한 상대를 만나 이번 주 첫 경기를 시작하고, 내 이름을 랭킹에 올려 보세요.",
      "cta.ios": " iPhone",
      "cta.android": "▶ Android",
      "cta.note": "무료 다운로드 · 광고 및 선택적 구매 포함",
      "footer.copy": "© 2026 MP Tennis League App · 테니스 선수가 테니스 선수를 위해 만들었습니다",
...
function applyLang(lang) {
  ...
  document.querySelector('meta[property="og:locale"]')?.setAttribute("content", ({ es: "es_ES", en: "en_US", ca: "ca_ES", ko: "ko_KR" })[lang]);
  ...
  document.querySelectorAll("[data-href-ko]").forEach((el) => {
    el.setAttribute("href", lang === "ko" ? el.getAttribute("data-href-ko") : el.getAttribute("data-href-default"));
  });
...
if (tourTrack) {
  ...
  slides.forEach((_, i) => {
    ...
    b.type = "button";
    b.setAttribute("aria-label", t("a11y.step").replace("{n}", String(i + 1)));
